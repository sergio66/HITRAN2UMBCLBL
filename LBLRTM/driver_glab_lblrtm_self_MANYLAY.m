...
%% function [w,dglab,dlblrtm] = driver_glab_lblrtm_self(gid,v1,v2,ipfile)  assumes N2 broadning, does NOT run "run8"
...
%%
%% example [w,dglab,dlblrtm] = driver_glab_lblrtm_self_MANYLAY(5,2130,2180,'/home/sergio/SPECTRA/IPFILES/co2two');
