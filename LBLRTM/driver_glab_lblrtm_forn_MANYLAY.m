function [w,dglab,dlblrtm] = driver_glab_lblrtm_forn_MANYLAY(gid,v1,v2,ipfile,iDoGlab,iTalk)
...
if iDoGlab > -2
  for ii = 1 : mm
    ...
    elseif iType == 500
      makeTAPE5_noN2con(gid,v1-15,v2+15,ipfile,dvx,ii,iTalk); %% Mlawer suggested larger bracket than 1 cm-1
    end
