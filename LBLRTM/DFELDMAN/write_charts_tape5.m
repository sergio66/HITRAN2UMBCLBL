...
% http://www.mathworks.com/matlabcentral/fileexchange/6461-lblrtm-wrapper-version-0-2/content/lnfl_lblrtm_radsum_wrappers/write_charts_tape5.m
...
DELPHI = 0;
  layer_type = ones(1,NLAY);
  scale_factor = ones(1,NLAY);
LTYP   = layer_type;
CLW    = scale_factor;

charts_directory
fid = fopen([charts_directory '/TAPE5'],'w');
