...
/bin/rm TAPE3 lblrtm xs FSCDXS slblrtm absco-ref_wv-mt-ckd.nc
...
#compiler=11  ## intel dbl/sgl      intel dbl compiles on chip, intel sgl does not compile on chip
compiler=10   ## intel dbl,gnu sgl  this works on chip
...
### v12.17 from what I downloaded from AER in Mar 2026
  ln -s /home/sergio/git/IR_NIR_VIS_UV_RTcodes/LBLRTM/LBLRTM12.17/LBLRTM/LNFL/run_examples/run_example_infrared_sergio/TAPE3_aer_v_3.8.1   TAPE3
  ln -s /home/sergio/git/IR_NIR_VIS_UV_RTcodes/LBLRTM/LBLRTM12.17/LBLRTM/cross-sections/xs                                                 xs
  ln -s /home/sergio/git/IR_NIR_VIS_UV_RTcodes/LBLRTM/LBLRTM12.17/LBLRTM/cross-sections/FSCDXS                                             FSCDXS
  ln -s /home/sergio/git/IR_NIR_VIS_UV_RTcodes/LBLRTM/LBLRTM12.17/LBLRTM/data/absco-ref_wv-mt-ckd.nc                                       absco-ref_wv-mt-ckd.nc
  
  if [ $compiler -eq 01 ]
  then
    echo 'see lner.sc .... linking to LBLRTM 12.17 ...gnu dbl sgl'
    ln -s /home/sergio/git/IR_NIR_VIS_UV_RTcodes/LBLRTM/LBLRTM12.17/LBLRTM/lblrtm_v12.17_linux_gnu_dbl                                  lblrtm
    ln -s /home/sergio/git/IR_NIR_VIS_UV_RTcodes/LBLRTM/LBLRTM12.17/LBLRTM/lblrtm_v12.17_linux_gnu_sgl                                  slblrtm
  elif [ $compiler -eq 10 ]
  then
    echo 'see lner.sc .... linking to LBLRTM 12.17 ...intel ifort sgl and dbl'
    ln -s /home/sergio/git/IR_NIR_VIS_UV_RTcodes/LBLRTM/LBLRTM12.17/LBLRTM/lblrtm_v12.17_linux_intel_dbl                                lblrtm
    ln -s /home/sergio/git/IR_NIR_VIS_UV_RTcodes/LBLRTM/LBLRTM12.17/LBLRTM/lblrtm_v12.17_linux_gnu_sgl                                  slblrtm    
  else
    echo 'lner.sc  ...incorrect LBLRTM compiled version for v12.17'
  fi
