...
% JOB = '020060506';
% JOB = 2+11
JOB = 6; %% '020050006' when testing 0.1 cm-1 and 0.05 cm-1 res for JClim 2021 paper
...
addpather = ['addpath /home/sergio/HITRAN2UMBCLBL/LBLRTM/ToffALL/Toff' num2str(Sgid) '_' num2str(Stoffset,'%02d')]; eval(addpather);
...
elseif iUsualORHigh == -4
  dvLBLRTM = 0.02;      %% 0.02 x 5 pt boxcar = 0.1     = what the JCLIM paper claims is fine
elseif iUsualORHigh == -5
  dvLBLRTM = 0.01;      %% 0.01 x 5 pt boxcar = 0.05   = want to see if there is a diff with 0.1 cm-1 == what the JCLIM paper claims is fine
elseif iUsualORHigh == -6
  dvLBLRTM = 0.005;     %% 0.005 x 5 pt boxcar = 0.025 = want to see if there is a diff with 0.1 cm-1 == what the JCLIM paper claims is fine
end
...
while fmin <= wn2
  ...
  for tt = Stt
    ...
    if exist(fout,'file') == 0 & iYes > 0
      ...
      cder = ['cd /home/sergio/HITRAN2UMBCLBL/LBLRTM/ToffALL/Toff' num2str(Sgid) '_' num2str(Stoffset,'%02d')]; eval(cder);
      pwd
