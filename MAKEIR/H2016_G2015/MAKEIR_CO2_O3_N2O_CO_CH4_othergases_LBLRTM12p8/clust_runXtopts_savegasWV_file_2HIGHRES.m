%% same as clust_runXtopts_savegasN_file_*.m except it figures which  "Toff2_" subdirs ....

%% this simply does all wavenumbers for gN

% now   sbatch --array=12-22 sergio_matlab_jobB.sbatch
...
addpather = ['addpath /home/sergio/HITRAN2UMBCLBL/LBLRTM/ToffWV2_' num2str(Stoffset,'%02d')]; eval(addpather);
...
while fmin <= wn2
  ...
  for tt = Stt
    ...
    if exist(fout,'file') == 0 & iYes > 0
      ...
      cder = ['cd /home/sergio/HITRAN2UMBCLBL/LBLRTM/ToffWV2_' num2str(Stoffset,'%02d')]; eval(cder);
	...
	elseif  gasid == 7 | gasid == 22
          %[w,dglab,dlblrtm] = driver_glab_lblrtm_forn_MANYLAY_N2O2true(gasid,fmin,fmax,['/home/sergio/SPECTRA/' fip],-1,-1,-1,dvLBLRTM); %% OLD
          [w,dglab,dlblrtm] = driver_glab_lblrtm_forn_MANYLAY_noN2con(gasid,fmin,fmax,['/home/sergio/SPECTRA/' fip],-1,-1,-1,dvLBLRTM); %% NEW
