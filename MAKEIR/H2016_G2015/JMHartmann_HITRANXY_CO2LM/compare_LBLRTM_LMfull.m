...
sf = input('enter scale factor to multiply LBLRTM fullline mix ods by : [really should be same ppm but 400/385=1.0390] ');
...
figure(3); plot(w,new./old); title('LMHitranFull/LBLRTMFirst')