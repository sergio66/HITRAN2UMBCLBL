...
gidlist = setdiff(3:47,[30 35 42]);   %% those last 3 are NOT in the breakout, and 
                                      %%% OOPS no profiles for 43,44,45,46,47
gidlist = setdiff(3:42,[30 35 42]);   %% those last 3 are NOT in the breakout

iX = input('Enter gas list (-1 for all from 3 to 42, [a b] to choose, and +N to specify ONE) : ');
if length(iX) == 1 & iX == -1
  gidlist = 3 : 42;
...
%iY = input('Enter year (-1) for this one : ');
iY = 2015;
