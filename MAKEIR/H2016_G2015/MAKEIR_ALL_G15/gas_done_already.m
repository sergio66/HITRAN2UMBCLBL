...
elseif iWhichFreqBoundaries == 2016
  ...
  dirout = diroutX;
elseif iWhichFreqBoundaries == 2015
  freq_boundaries
  lala = strfind(dirout,'G2015_RUN8_NIRDATABASE');
  lenx = length('G2015_RUN8_NIRDATABASE');
  diroutX = dirout;
  diroutX(lala:lala+lenx-1) = 'G2015_RUN8_NIRDATABASE';
  dirout = diroutX;
