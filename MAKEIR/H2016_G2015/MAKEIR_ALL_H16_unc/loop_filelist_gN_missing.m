...
disp('highly suggest riunning loop_rmerxN.m first!')
disp('ret'); pause
...
for ii = 1 : length(gids)
  ...
  fdir = ['/asl/s1/sergio/H2016_RUN8_NIRDATABASE/IR_605_2830_unc/g' num2str(gid) '.dat'];
  ee = exist(fdir,'dir');
  if ee == 0
...
disp(' ')
disp('gid   number of needed files')
disp('---------------------------')
[gids; iaTotalNeed]'
disp('---------------------------')
