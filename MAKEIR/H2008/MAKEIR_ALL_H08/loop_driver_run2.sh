...
workfile=$1;
workdir='/home/sergio/HITRAN2UMBCLBL/MAKEIR_ALL_H08/';
...
#/asl/opt/bin/matlab -nodisplay -nodesktop -nosplash -r "$default; gX_forwards_nir_runXtopts_savegasX2_jmhartmann_2007; exit;" $logger
/asl/opt/bin/matlab -nodisplay -nodesktop -nosplash -r "$default; gX_forwards_nir_runXtopts_savegasX2_jmhartmann_2010; exit;" $logger
