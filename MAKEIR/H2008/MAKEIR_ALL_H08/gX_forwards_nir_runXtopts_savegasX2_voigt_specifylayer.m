...
rmer = ['!/bin/rm  /asl/s1/sergio/RUN8_NIRDATABASE/IR_605_2830_H08/g2.dat/test_std705_2_6vanhuberUMBC.mat'];
eval(rmer);
...
%      fprintf(fid,'%3i %10.8f %10.8f %7.3f %10.8e \n',profile);
      ...
      fout = [dirout '/test_std' num2str(fmin)];
      if LVG == 'V'
      ...
      if gasid > 1 & iYes > 0 & ee == 0
        ...
        eval(toucher);
        topts.xfar = 250;   %% use lines this far from chunk, already done
