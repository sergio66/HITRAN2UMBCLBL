...
% clustcmd -L g2_forwards_runXtopts_savegasXversB_363ppm.m 1:11
%
% otherwise when happy
% clustcmd -q medium -n 11 g2_forwards_runXtopts_savegasXversB_363ppm.m 1:11
...
fprintf(1,'this is g2_forwards_runXtopts_savegasXversB_363ppm.m solzen = %3i TOFF = %3i \n',solzen,iProfile*10);
...
while fmin <= wn2
  ...
  for pp = iProfile
    ...
    if gasid > 1 & ee == 0
      ...
      sedder = [sedder homedir '/quickuseNLTE_template_363ppm.nml > ' fnml];
      eval(sedder);
