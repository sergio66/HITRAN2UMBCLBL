...
% clustcmd -L g2_forwards_runXtopts_savegasX.m 1:7
%
% otherwise when happy
% clustcmd -q medium -n 7 g2_forwards_runXtopts_savegasX.m 1:7
...
raSolarAngles = [0 40 60 80 85 90 120];

addpath /home/sergio/HITRAN2UMBCLBL/MAKEIR_4umNLTE
homedir = pwd;

JOB
solzen = raSolarAngles(JOB(1));
fprintf(1,'this is g2_forwards_runXtopts_savegasX.m solzen = %3i \n',solzen);
