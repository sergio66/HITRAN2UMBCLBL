...
%% cd ~/HITRAN2UMBCLBL/MAKEIR_ALL_H08/
cd /home/sergio/HITRAN2UMBCLBL/MAKEIR/H2008/MAKEIR_ALL_H08_NOBASEMENT
...
fdir = ['/asl/s1/sergio/H2008_RUN8_NIRDATABASE/IR_605_2830_H08/g' num2str(gid) '.dat/WOBASEMENT/'];
ee = exist(fdir,'dir');
if ee == 0
