...
% clustcmd -L clust_runXtopts_savegas2_file.m '020060501'
%
% otherwise when happy
% clustcmd -q medium -n 64 clust_runXtopts_savegas2_file.m g2_list.txt
%
% or
% clustcmd -q long_contrib -n 64 clust_runXtopts_savegas2_file.m g2_list.txt
...
while fmin <= wn2
  ...
  for tt = Stt
    ...
    if exist(fout,'file') == 0 & iYes > 0
      ...
      [w,d] = run8co2_hartmann(gasid,fmin,fmax,fip,topts);
