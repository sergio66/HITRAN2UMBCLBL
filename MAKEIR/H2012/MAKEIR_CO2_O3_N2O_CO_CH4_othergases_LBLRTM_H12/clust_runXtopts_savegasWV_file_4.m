...
addpather = ['addpath /home/sergio/HITRAN2UMBCLBL/LBLRTM/Toff4_' num2str(Stoffset,'%02d')]; eval(addpather);
...
while fmin <= wn2
  ...
  for tt = Stt
    ...
    if exist(fout,'file') == 0 & iYes > 0
      ...
      cder = ['cd /home/sergio/HITRAN2UMBCLBL/LBLRTM/Toff4_' num2str(Stoffset,'%02d')]; eval(cder);
