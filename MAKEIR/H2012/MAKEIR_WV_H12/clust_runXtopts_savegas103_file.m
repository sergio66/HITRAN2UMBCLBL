...
% clustcmd -L clust_runXtopts_savegas103_file.m '010060501'
%
% otherwise when happy
% clustcmd -q medium -n 64 clust_runXtopts_savegas103_file.m g103_1105_list.txt
%
% or
% clustcmd -q long_contrib -n 64 clust_runXtopts_savegas103_file.m g103_1105_list.txt
