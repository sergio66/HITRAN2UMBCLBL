...
dirx = '/asl/s1/sergio/H2012_RUN8_NIRDATABASE/IR_605_2830/g2.dat/hartmann/';
iCnt = 0;
for ff = 605 : 25 : 2805
  iCnt = iCnt + 1;
  for tt = tt0
...
clear all
dirx = '/asl/s1/sergio/H2012_RUN8_NIRDATABASE/IR_605_2830/g2.dat/hartmann/kcomp/';
dirZ = '/asl/s1/sergio/H2012_RUN8_NIRDATABASE/IR_605_2830/g2.dat/hartmann/kcompNOZEROS/';
iCnt = 0;
for ff = 605 : 25 : 2805
  iCnt = iCnt + 1;
