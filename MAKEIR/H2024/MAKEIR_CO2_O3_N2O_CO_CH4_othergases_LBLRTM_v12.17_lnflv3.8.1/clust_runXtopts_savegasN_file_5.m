...
%% same as clust_runXtopts_savegasN_file_2.m except it goes to "Toff5_" subdirs ....
...
adderpath
addpather = ['addpath /home/sergio/HITRAN2UMBCLBL/LBLRTM/ToffALL/Toff5_' num2str(Stoffset,'%02d')]; eval(addpather);
...
while fmax >= wn1 + dv
  ...
  for tt = Stt
    ...
    if exist(fout,'file') == 0 & iYes > 0
      ...
      cder = ['cd /home/sergio/HITRAN2UMBCLBL/LBLRTM/ToffALL/Toff5_' num2str(Stoffset,'%02d')]; eval(cder);
