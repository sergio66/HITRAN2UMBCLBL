...
%%  <<<< for JOBB = 1 : 22; clust_runXtopts_savegasN_file_5; end >>>>
...
adderpath
addpather = ['addpath ' outputdirToffALL '/Toff5_' num2str(Stoffset,'%02d')]; eval(addpather);
...
while fmin <= wn2
  ...
  for tt = Stt
    ...
    if exist(fout,'file') == 0 & iYes > 0
      ...
      cder = ['cd ' outputdirToffALL '/Toff5_' num2str(Stoffset,'%02d')]; eval(cder);
