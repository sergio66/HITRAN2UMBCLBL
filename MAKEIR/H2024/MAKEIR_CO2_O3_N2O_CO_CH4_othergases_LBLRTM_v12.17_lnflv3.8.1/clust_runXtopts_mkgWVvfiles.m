...
slash = findstr(dirout,'/');
diroutXN = [dirout(1:slash(6)) '/' dirlbl '/WV/abs.dat'];
...
elseif iUsualORHigh == -1
  diroutXN = [dirout(1:slash(6)) '/' dirlbl '/WV/abs.dat0.0005/'];
elseif iUsualORHigh == -2
  diroutXN = [dirout(1:slash(6)) '/' dirlbl '/WV/abs.dat0.0001/'];
elseif iUsualORHigh == -3
  diroutXN = [dirout(1:slash(6)) '/' dirlbl '/WV/abs.dat0.0002/'];
end
