...
elseif iUsualORHigh == -1
  dirout = [xdirout '/g' num2str(gid) '.dat/lblrtm0.0005/'];   %% high res for kcarta
elseif iUsualORHigh == -2
  dirout = [xdirout '/g' num2str(gid) '.dat/lblrtm0.0001/'];   %% very high res for kcarta, I went for this
elseif iUsualORHigh == -3
  dirout = [xdirout '/g' num2str(gid) '.dat/lblrtm0.0002/'];   %% very high res for kcarta, Guido pointed out dv=1.9945e-04 cm-1 is the limiting res for 580-1205 cm-1
elseif iUsualORHigh == -4
  dirout = [xdirout '/g' num2str(gid) '.dat/lblrtm0.1/'];      %% very lo res
elseif iUsualORHigh == -5
  dirout = [xdirout '/g' num2str(gid) '.dat/lblrtm0.05/'];     %% quite lo res
elseif iUsualORHigh == -6
  dirout = [xdirout '/g' num2str(gid) '.dat/lblrtm0.025/'];    %% lo res
end
