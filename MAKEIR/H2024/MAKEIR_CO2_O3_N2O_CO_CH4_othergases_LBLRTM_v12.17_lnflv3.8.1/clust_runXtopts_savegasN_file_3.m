...
%% same as clust_runXtopts_savegasN_file_2.m except it goes to "Toff3_" subdirs ....
...
adderpath
addpather = ['addpath /home/sergio/HITRAN2UMBCLBL/LBLRTM/ToffALL/Toff3_' num2str(Stoffset,'%02d')]; eval(addpather);
...
while fmin <= wn2
  ...
  for tt = Stt
    ...
    if exist(fout,'file') == 0 & iYes > 0
      ...
      cder = ['cd /home/sergio/HITRAN2UMBCLBL/LBLRTM/ToffALL/Toff3_' num2str(Stoffset,'%02d')]; eval(cder);
