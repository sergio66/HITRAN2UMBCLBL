...
gasIDlist = load('g103_1105_list.txt');
  ...
  for pp = Spp 
    ...
    for mm = 1 : 5
      ...
      if exist(fout,'file') == 0 & iYes > 0
        ...
        [w,d,hitran_fname] = run8water(gasid,fmin,fmax,fip,topts);  
...
fprintf(1,'clust_runXtopts_savegas103_file.m : JOB = %4i done, used hitran_fname = %s \n',hitran_fname);
