function mat2forGENERIC(chunkprefix, gid, vchunk, cdir, fdir, CKD, dv, dtype)

% function mat2forGENERIC(gid, vchunk, cdir, fdir, dtype)
%
...
loader = ['load ' cdir '/cg' num2str(gid) 'v' num2str(vchunk) '_CKD_' num2str(CKD) '.mat'];
eval(loader);
...
fsave = [chunkprefix num2str(vchunk) '_g' num2str(gid) '_CKD_' num2str(CKD) '.dat'];
