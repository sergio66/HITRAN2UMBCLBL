...
fchunks = 0605 : 01 : 0855; fx = 0;     %% ALL
fchunks = 0855 : 01 : 1205; fx = 0;     %% ALL
...
for gg = 1 : length(gases)
  ...
  if gid == 1
    ...
    cdir = '/asl/s1/sergio/H2012_RUN8_NIRDATABASE/IR_2405_3005_WV/g1.dat/lblrtm0.0001/kcomp.h2o/';
  ...
  elseif gid == 103
    ...
    cdir = '/asl/s1/sergio/H2012_RUN8_NIRDATABASE/IR_2405_3005_WV/g103.dat/lblrtm0.0001/kcomp.h2o/';
    fdir = '/asl/data/kcarta_sergio/H2012.ieee-le/IR605/etc.ieee-le/lblrtm0.0001/';
  ...
  elseif gid == 110
    ...
    gidx = gid;
    cdir = '/asl/s1/sergio/H2016_RUN8_NIRDATABASE/IR_605_2830//lblrtm12.8//kcomp.h2o/0.0001/';
    fdir = '/asl/data/kcarta/H2016.ieee-le/IR605/etc.ieee-le/lblrtm0.0001/';
    gidxx = 1;

    gidx = gid;
    cdir = '/asl/s1/sergio/H2016_RUN8_NIRDATABASE/IR_605_2830//lblrtm12.8//kcomp.h2o/0.0002/';
    fdir = '/asl/data/kcarta/H2016.ieee-le/IR605/etc.ieee-le/lblrtm0.0002/';
    fdir = '/asl/rta/kcarta/H2016.ieee-le/IR605/etc.ieee-le/lblrtm0.0002/';
    gidxx = 1;
  ...
  for ff = 1 : length(fchunks);
    ...
    if ee > 0
      ...
      chunkprefix = 'y';  %% 0.0002 or 0.0001????? nah use 0.0002
      fprintf(1,'%s does exist, processing .... \n',fname);
      mat2forGENERIC(chunkprefix, gidxx, vchunk, cdir, fdir, dtype, 0.0002)
    else
