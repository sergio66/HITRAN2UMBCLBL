function cmprunFIR6(glist, vlist)
...
%{
homedir = pwd;
cder = ['cd /home/sergio/HITRAN2UMBCLBL/MAKEFIR6']; eval(cder);
...
if nargin < 2
  ...
  vlist = 30 : 1 : 50; % default to all frequency chunks
end
...
%       gdir = [dirout '/abs.dat/']; 
%       cdir = [dirout '/kcomp.h2o/']; 
       gdir = '/asl/s1/sergio/H2012_RUN8_NIRDATABASE/FIR30_50/g1.dat/abs.dat';
       cdir = '/asl/s1/sergio/H2012_RUN8_NIRDATABASE/FIR30_50/g1.dat/kcomp';
     case 2
%       gdir = [dirout '/abs.dat/']; 
%       cdir = [dirout '/kcomp/']; 
       gdir = '/asl/s1/sergio/H2012_RUN8_NIRDATABASE/FIR30_50/abs.dat';
