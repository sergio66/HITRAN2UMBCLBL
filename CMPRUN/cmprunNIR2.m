function cmprunNIR2(glist, vlist)
...
homedir = pwd;
cder = ['cd /home/sergio/HITRAN2UMBCLBL/MAKENIR/H2012/MAKENIR2']; eval(cder);
...
for gid00 = 1 : length(glist)
   ...
   switch gid
     case 1
       gdir = '/spinach/s6/sergio/RUN8_NIRDATABASE/NIR3550_5550/abs.dat'; 
