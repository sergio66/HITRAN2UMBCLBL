function cmprunFIR7(glist, vlist)
...
addpath /home/sergio/HITRAN2UMBCLBL
...
%{
homedir = pwd;
cder = ['cd /home/sergio/HITRAN2UMBCLBL/MAKEFIR7']; eval(cder);
...
if nargin < 2
  ...
  vlist = 15 : 0.5 : 30; % default to all frequency chunks
end
if nargin < 1
...
%       gdir = [dirout '/abs.dat/']; 
%       cdir = [dirout '/kcomp.h2o/']; 
       gdir = '/asl/s1/sergio/H2012_RUN8_NIRDATABASE/FIR15_30/g1.dat/abs.dat';
       cdir = '/asl/s1/sergio/H2012_RUN8_NIRDATABASE/FIR15_30/g1.dat/kcomp';
     case 2
%       gdir = [dirout '/abs.dat/']; 
%       cdir = [dirout '/kcomp/']; 
       gdir = '/asl/s1/sergio/H2012_RUN8_NIRDATABASE/FIR15_30/abs.dat';
