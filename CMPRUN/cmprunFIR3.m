function cmprunFIR3(glist, vlist)
...
if nargin < 2
  vlist = 140:05:310; % default to all frequency chunks
end
if nargin < 1
...
for gid00 = 1 : length(glist)
   ...
   switch gid
     case 1
       gdir = '/spinach/s6/sergio/RUN8_NIRDATABASE/FIR140_310/abs.dat'; 
       cdir = '/spinach/s6/sergio/RUN8_NIRDATABASE/FIR140_310/kcomp.h2o'; 
       gdir = '/asl/s1/sergio/H2012_RUN8_NIRDATABASE/FIR140_310/g1.dat/abs.dat';
     ...
     case 2
       ...
       gdir = '/asl/s1/sergio/H2012_RUN8_NIRDATABASE/FIR140_310/abs.dat';
