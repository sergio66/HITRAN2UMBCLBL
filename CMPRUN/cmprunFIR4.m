function cmprunFIR4(glist, vlist)
...
if nargin < 2
  vlist = 80:2.5:150; % default to all frequency chunks
end
if nargin < 1
...
for gid00 = 1 : length(glist)
   ...
   switch gid
     case 1
       gdir = '/spinach/s6/sergio/RUN8_NIRDATABASE/FIR80_150/abs.dat'; 
       cdir = '/spinach/s6/sergio/RUN8_NIRDATABASE/FIR80_150/kcomp.h2o'; 
       gdir = '/asl/s1/sergio/H2012_RUN8_NIRDATABASE/FIR80_150/g1.dat/abs.dat';
       cdir = '/asl/s1/sergio/H2012_RUN8_NIRDATABASE/FIR80_150/g1.dat/kcomp';
     case 2
       gdir = '/spinach/s6/sergio/RUN8_NIRDATABASE/FIR80_150/abs.dat'; 
       cdir = '/spinach/s6/sergio/RUN8_NIRDATABASE/FIR80_150/kcomp';
       gdir = '/asl/s1/sergio/H2012_RUN8_NIRDATABASE/FIR80_150/abs.dat';
