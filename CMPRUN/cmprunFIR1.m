...
for gid00 = 1 : length(glist)
   ...
   switch gid
     case 1
       gdir = '/spinach/s6/sergio/RUN8_NIRDATABASE/FIR500_605/abs.dat'; 
       cdir = '/spinach/s6/sergio/RUN8_NIRDATABASE/FIR500_605/kcomp.h2o'; 
       gdir = '/asl/s1/sergio/H2012_RUN8_NIRDATABASE/FIR500_605/g1.dat/abs.dat';
     ...
     case 2
       ...
       gdir = '/asl/s1/sergio/H2012_RUN8_NIRDATABASE/FIR500_605/abs.dat';
